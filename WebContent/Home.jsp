						...
						<div class="w-nav navbar" data-collapse="medium"
							...
							<div class="w-container nav">
								...
								<nav class="w-nav-menu nav-menu" role="navigation"> <a
									...
									class="w-nav-link menu-li" href="Home.jsp#login">LOGIN</a> 
				...
				<div class="overlay">
					...
					<div class="center fixed-content">
						<div class="center-fix">
							<h1 class="underline animated fadeInDown" style="color: white;">Farm-Kart</h1>
							<h4 class="animated fadeInUp delay-05s"
								style="margin-bottom: 50px;color: white;">
								<strong>A online market for farmers and buyers </strong>
							</h4>
